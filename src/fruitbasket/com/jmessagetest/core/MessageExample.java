...
public class MessageExample {
    ...
    private static final String APP_KEY =JMessageCondition.APP_KEY;
    private static final String MASTER_SECRET =JMessageCondition.MASTER_SECRET;
    ...
    public static void testSendSingleTextByAdmin() {
        ...
        try {
            MessageBody body = MessageBody.text("Message: from admin");
            SendMessageResult result = client.sendSingleTextByAdmin(JMessageCondition.otherName,JMessageCondition.userName, body);
